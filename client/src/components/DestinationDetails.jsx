...
const DestinationDetails = () => {
  ...
  useEffect(() => {
    const fetchDestinationDetails = async () => {
      try {
        setLoading(true);
        // TODO: Replace with your own destination details API
        ...
        const mockDestination = {
          ...
          photos: [`https://source.unsplash.com/800x600/?travel,destination`]
        };
          ...
          <Grid item xs={12} md={6}>
            <Card>
              <CardMedia
                component="img"
                height="400"
                image={destination.photos?.[0] || `https://source.unsplash.com/800x600/?${encodeURIComponent(destination.name)}`}
