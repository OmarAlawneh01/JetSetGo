...
// Search for flights
export const searchFlights = async (originCode, destinationCode, departureDate, returnDate, adults) => {
  try {
...
// Search for hotels
export const searchHotels = async (cityCode, checkInDate, checkOutDate, adults) => {
  try {
    const token = await getAmadeusToken();
